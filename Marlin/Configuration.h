...
#define CUSTOM_MACHINE_NAME "Rotary Laser"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 716.22, 400, 100 } 

/**
 * 100 for cnc 
 * 673.2 for tekeya bottles with 242.6 circ
 * 710.5 for megellan outdoor tumblers (avg 81.5 mm diameter)
 * 708.6 fr kingso
 */
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 50, 50, 30, 25 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 200, 200, 35, 10000 }
...
#define X_MIN_POS -570
#define Y_MIN_POS -570
